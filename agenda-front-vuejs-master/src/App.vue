<template>
  <div id="app">
    ...
    <div class="container">
      ...
      <!--Formulário para adição de um contato-->
      <form @submit.prevent="salvar">
          ...
          <button class="waves-effect black btn-small">Salvar<i class="material-icons left">save_alt</i></button>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr v-for="contato of contatos" :key="contato.id_contato">
            ...
            <!--Botões de editar e excluir contatos-->
            <td>
              <button @click="editar(contato)" class="waves-effect btn-small grey darken-3"><i class="material-icons">create</i></button>
              <button @click="apagar(contato)" class="waves-effect btn-small red darken-1"><i class="material-icons">delete_forever</i></button>
            </td>
